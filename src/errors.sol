...
library errors {
    ...
    function with(bytes4 errorSel, bool arg1) internal {
        vm.expectRevert(abi.encodeWithSelector(errorSel, arg1));
    }

    function with(bytes4 errorSel, bytes32 arg1) internal {
        vm.expectRevert(abi.encodeWithSelector(errorSel, arg1));
    }

    function with(bytes4 errorSel, string memory arg1) internal {
        vm.expectRevert(abi.encodeWithSelector(errorSel, arg1));
    }

    function with(bytes4 errorSel, uint256 arg1) internal {
        vm.expectRevert(abi.encodeWithSelector(errorSel, arg1));
    }
